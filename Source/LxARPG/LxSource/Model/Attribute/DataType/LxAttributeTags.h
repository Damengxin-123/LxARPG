...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_Attribute_Percentage_MovementSpeedBonus);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_Attribute_Numeric_BaseMovementSpeed);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_Attribute_Range);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_Attribute_Range_AttackPower);
