...
struct LXARPG_API FLxAttributeModifierEffect
{
	...
	/** 目标属性 ID。 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="效果|属性", DisplayName="目标属性ID")
	ELxCharacterAttributeID AttributeID = ELxCharacterAttributeID::X_None;

	/** 目标属性标签 ID，优先用于未来替代枚举 ID。 */
...
struct LXARPG_API FLxAttributeRecoveryEffect
{
	...
	/** 目标属性 ID。 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="效果|属性恢复", DisplayName="目标属性ID")
	ELxCharacterAttributeID AttributeID = ELxCharacterAttributeID::X_None;
...
struct LXARPG_API FLxDamageEffect
{
	...
	/** 伤害目标属性，通常为生命值当前值。 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="效果|伤害", DisplayName="目标属性ID")
	ELxCharacterAttributeID TargetAttributeID = ELxCharacterAttributeID::C_HP;
