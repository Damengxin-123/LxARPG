...
/** 玩家操控组件持有的交互 UObject 模块，维护候选队列、选项刷新和多级交互导航。 */
UCLASS(BlueprintType, Blueprintable, EditInlineNew, DefaultToInstanced, DisplayName="玩家交互模块")
class LXARPG_API ULxPlayerInteractionModule : public ULxPlayerControlModuleBase
{
	GENERATED_BODY()
