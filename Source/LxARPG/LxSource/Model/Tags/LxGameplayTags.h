...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Lifecycle_Alive);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Lifecycle_Dead);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Movement);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Movement_Idle);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Movement_Moving);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Movement_Jumping);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Movement_Airborne);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Movement_Landing);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Movement_Running);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Combat);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Combat_Attacking);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Combat_Blocking);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Combat_Casting);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Combat_Charging);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Combat_Sustaining);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Combat_Aiming);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Combat_CombatFacing);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(LxTag_CharacterState_Combat_Hurt);
